                    ...
                    internal static partial class Item
                    {
                        internal static partial class NoteRest
                        {
                            internal static partial class Rest
                            {
                                ...
                                {
                                    //if (note.notations != null) { Debug.LogError("HUJAHUJA"); }
                                    spRest = note.GetRest();
                                    ...
                                    if (note.printobjectSpecified && note.printobject == yesno.no)
                                    {
                                        nsRest.SetAlpha(NSSettingsStatic.hiddenObjectsAlpha);
                                        nsRest.hidden = true;
                                    }
