                        ...
                        internal static partial class NoteRest
                        {
                            internal static partial class Rest
                            {
                                ...
                                internal static void Parse(note note)
                                {
                                    ...
                                    nsRest = nsStaveFixed.AddObject<NSRest>( PoolEnum.NS_MOVABLE);
                                    ...
                                    else
                                    {
                                        ...
                                        if (spNote.HasDot())
                                        {
                                            nsRest.options.dotsCount = spNote.GetDotCount();
                                        }
                                    ...
                                    {
                                        float y = nsRest.GetPositionOnStave((int)spRest.displaystep.ToNS(), int.Parse(spRest.displayoctave), nsStaveFixed.parsing.clef);
