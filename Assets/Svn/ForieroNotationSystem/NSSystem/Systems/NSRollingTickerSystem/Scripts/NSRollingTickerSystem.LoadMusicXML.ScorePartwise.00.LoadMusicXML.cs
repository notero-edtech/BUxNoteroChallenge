...
namespace ForieroEngine.Music.NotationSystem.Systems
{
    public partial class NSRollingTickerSystem : NS
    {
        ...
        {
            static NSRollingTickerSystem ns = null;
            ...
            public static void LoadMusicXML(NSRollingTickerSystem ns, byte[] bytes)
            {
                Reset();
                ...
                directionSign = NSPlayback.NSTickerPlayback.rollingMode switch
                {
                    NSPlayback.NSTickerPlayback.RollingMode.Right => -1f,
                    NSPlayback.NSTickerPlayback.RollingMode.Left => 1f,
                    _ => directionSign
                };
                        ...
                        for (measureIndexer = 0; measureIndexer < spPart.measure.Length; measureIndexer++)
                        {
                            ...
                            for (measureItemsIndexer = 0; measureItemsIndexer < spMeasure.Items.Length; measureItemsIndexer++)
                            {
                                ...
                                switch (spMeasureItem)
                                {
                                    ...
                                    case barline: break;
                                    case bookmark: break;
                                    case direction spDirection: Part.Measure.Item.Direction.Parse(spDirection); break;
