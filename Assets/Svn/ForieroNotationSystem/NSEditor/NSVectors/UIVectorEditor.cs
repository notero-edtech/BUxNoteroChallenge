...
{
    [CustomEditor(typeof(UIVector))]
    [CanEditMultipleObjects]
    public class UIVectorEditor : Editor
    {
        UIVector o;
        ...
        void OnEnable()
        {
            ...
            o = serializedObject.targetObject as UIVector;
            ...
            vectors.Add(VectorEnum.DurationBarHorizontal, serializedObject.FindProperty("durationBarHorizontal"));
        }
