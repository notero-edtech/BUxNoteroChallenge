...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Pause both background Easings or active action Easings.")]
	public class EasingPause : FsmStateAction
	{
		...
		{
			base.OnEnter();
			UnityExtensions.PauseAnimateTo(id.IsNone ? "" : id.Value, contains, category.IsNone ? "" : category.Value);
			Finish();
		}
