...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Follows an object scale.")]
	public class EasingScaleUpdate : FsmStateAction
	{
		...
		public override void OnEnter ()
		{
			...
			if(go){
				Fsm.Owner.StartCoroutine(go.transform.ScaleUpdate(
