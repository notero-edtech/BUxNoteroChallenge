...
public static partial class UnityExtensions {
	...
	public static IEnumerator ShakePosition(this Transform aTransform,
	                                 float aDuration,
	                                 float aDelay,
	                                 Vector3 aShake,
	                                 Space aSpace,
	                                 ...
	                                 string anId)
	{
		...
		vector3s[3] = aTransform.eulerAngles;		
		...
		while(duration > 0f)
		{
			...
			//impact:
			if (impact == true) {
				aTransform.Translate(vector3s[1], Space.World);
				impact = false;
			}
			
			//reset:
			aTransform.position = vector3s[0];
			...
			//apply:
			aTransform.Translate(vector3s[2], aSpace);	
