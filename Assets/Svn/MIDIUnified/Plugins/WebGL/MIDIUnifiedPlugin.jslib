var MIDIUnifiedPlugin = {
    ...
    MidiIn_PortCount: function() { if(G.initialized && G.midi !== undefined) { return G.midi.inputs.size; } else { return 0; } },
    MidiIn_PortAdded: function() { if(G.initialized && G.midi !== undefined){ return false;} else { return false; } },
    MidiIn_PortRemoved: function() { if(G.initialized && G.midi !== undefined){ return false; } else { return false; } },
    ...
    MidiOut_PortCount: function() { if(G.initialized && G.midi !== undefined){ return G.midi.outputs.size; } else { return 0; } },
    MidiOut_PortAdded: function() { if(G.initialized && G.midi !== undefined){ return false; } else { return false; } },
    MidiOut_PortRemoved: function() { if(G.initialized && G.midi !== undefined){ return false;} else { return false; } },
    MidiOut_SendMessage: function(command, data1, data2) { return 0; },   
    MidiOut_SendData: function(data, dataSize) { return 0; }   
};
