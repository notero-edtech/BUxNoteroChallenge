...
namespace ForieroEngine.MIDIUnified
{
    ...
    public static class TimeSignatureExtensionMethods
    {
        ...
        {
            var value = Math.Abs((int)timeSignature);
            return value is >= 0 and <= 3 ? TimeSignatureNames[value] : $"{value} Not supported time signature.";
        }

        public static int BeatsPerMeasure(this TimeSignatureEnum timeSignature) =>
            timeSignature switch
            {
                TimeSignatureEnum.TwoTwo => 2,
                TimeSignatureEnum.ThreeFour => 3,
                TimeSignatureEnum.FourFour => 4,
                TimeSignatureEnum.SixEight => 6,
                _ => 4
            };
    }
    ...
    public enum PercussionEnum
    {
        ...
        OpenTriangle = 81,
        /// <summary>General MIDI percussion ("Undefined").</summary>
    ...
    public static class PercussionExtensionMethods
    {
        ...
        public static bool IsValid(this PercussionEnum percussion) => (int)percussion >= 35 && (int)percussion <= 81;
        ...
        public static string Name(this PercussionEnum percussion) => percussion == PercussionEnum.Undefined ? "Undefined" : PercussionNames[(int)percussion - 35];
    }
}
