...
#pragma warning disable 67
	...
	public static void SetBeats (int aBeatsNumerator)
	{
        ...
        OnChange?.Invoke(beat, beatsNumerator, beatsDenominator);
    }
	...
	public static void Start (int aBeatsNumerator, int aBeatsDenominator, int aBeatsPerMinute)
	{
        ...
        OnStart?.Invoke(beat, beatsNumerator, beatsDenominator);
    }
	...
	public static void Stop ()
	{
        ...
        OnStop?.Invoke(beat, beatsNumerator, beatsDenominator);
    }
	...
	static void OnInternalTimer ()
	{
        ...
        OnBeat?.Invoke(beat, beatsNumerator, beatsDenominator);
    }

	public static void BeatEvent (int aBeat, int aBeatsNumerator, int aBeatsDenominator)
	{
        OnBeat?.Invoke(aBeat, aBeatsNumerator, aBeatsDenominator);
    }
