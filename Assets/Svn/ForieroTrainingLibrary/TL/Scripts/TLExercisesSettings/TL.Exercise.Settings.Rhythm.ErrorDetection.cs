...
namespace ForieroEngine.Music.Training
{
	public static partial class TL
	{
		public partial class ExerciseSettings
		{
			...
			{
				public RhythmErrorDetectionSettings errorDetectionSettings = new RhythmErrorDetectionSettings();

				[Serializable]
				public partial class RhythmErrorDetectionSettings
				{
					#region general
