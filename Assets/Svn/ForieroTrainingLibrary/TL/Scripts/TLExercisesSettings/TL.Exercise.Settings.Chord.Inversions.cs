...
namespace ForieroEngine.Music.Training
{
	public static partial class TL
	{
		public partial class ExerciseSettings
		{
			...
			{
				public ChordInversionsSettings inversionsSettings = new ChordInversionsSettings();

				[Serializable]
				public class ChordInversionsSettings
				{
					#region general
					...
					[Tooltip("")]
					[EnumFlags]
					public Enums.Chord.ChordInversionTypeFlags chordInversionTypeFlags = Enums.Chord.ChordInversionTypeFlags.Root;
