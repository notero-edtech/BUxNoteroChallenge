...
namespace ForieroEngine.Music.Training
{
    public static partial class TL
    {
        ...
        {
            public partial class IntervalOptions
            {
                public IntervalIdentificationOptions identificationOptions = new IntervalIdentificationOptions();

                [Serializable]
                public partial class IntervalIdentificationOptions
                {
