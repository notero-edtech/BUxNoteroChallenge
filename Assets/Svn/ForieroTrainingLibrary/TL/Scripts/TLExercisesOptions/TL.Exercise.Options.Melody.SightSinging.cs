...
namespace ForieroEngine.Music.Training
{
    public static partial class TL
    {
        ...
        {
            public partial class MelodyOptions
            {
                public MelodySightSingingOptions sightSingingOptions = new MelodySightSingingOptions();

                [Serializable]
                public class MelodySightSingingOptions
                {
