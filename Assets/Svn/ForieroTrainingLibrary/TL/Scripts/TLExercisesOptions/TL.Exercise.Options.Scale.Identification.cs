...
namespace ForieroEngine.Music.Training
{
    public static partial class TL
    {
        ...
        {
            public partial class ScaleOptions
            {
                public ScaleIdentificationOptions identificationOptions = new ScaleIdentificationOptions();

                [Serializable]
                public partial class ScaleIdentificationOptions
                {
