...
namespace ForieroEngine.Music.Detection
{
    ...
    public class PitchTracker
    {
        ...
        private const float kMinFreq = 50.0f;
        // A1, Midi note 33, 55.0Hz
        private const float kMaxFreq = 1600.0f;
        // A#6. Midi note 92
        private const int kStartCircular = 40;
        // how far into the sample buffer do we start checking (allow for filter settling)
        ...
        private const float kCircularBufSaveTime = 1.0f;
