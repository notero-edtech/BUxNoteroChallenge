...
namespace ForieroEngine
{
    public class EventManager : MonoBehaviour
    {
        ...
        static void Init()
        {
            ...
            DontDestroyOnLoad(new GameObject("EventManager").AddComponent<EventManager>());
            //if(ForieroDebug.CodePerformance) Debug.Log("METHOD STOPWATCH (EventManager - BeforeSceneLoad): " + stopWatch?.Elapsed.ToString());
        }
