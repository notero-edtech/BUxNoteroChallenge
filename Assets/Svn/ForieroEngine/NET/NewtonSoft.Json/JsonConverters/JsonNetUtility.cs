...
namespace ForieroEngine.Newtonsoft.JsonConverters{
	...
	public static class JsonNetUtility{
		...
		/// 	2. All <c>Newtonsoft.Json.JsonConverter</c> from <c>ForieroEditor.Newtonsoft.JsonConverters</c>.
		...
		private static Type[] FindConverterTypes(){
			return TypeCache.GetTypesDerivedFrom<JsonConverter>()
				...
				.OrderBy((type) => null != type.Namespace && type.Namespace.StartsWith("ForieroEngine")
