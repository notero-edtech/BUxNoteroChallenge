...
namespace ForieroEditor.Coroutines
{
    public class EditorCoroutineStart
    {
        [MenuItem("Foriero/Others/Coroutines/Kill")]
...
#pragma warning disable CS0618 // Type or member is obsolete
                    else if (currentType == typeof(WWW))
                    {
                        ...
                        if (www != null && !www.isDone) isWaiting = true;
                    }
#pragma warning restore CS0618 // Type or member is obsolete
                    else if (currentType == typeof(UnityWebRequestAsyncOperation))
                    {
                        // Web download request, lets see if its done!
                        var www = current as UnityWebRequestAsyncOperation;
                        if (www != null && !www.isDone) isWaiting = true;
                    }
