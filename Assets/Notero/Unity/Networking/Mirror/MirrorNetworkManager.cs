...
namespace Notero.Unity.Networking.Mirror
{
    public class MirrorNetworkManager : NetworkManager
    {
        ...
        public static new MirrorNetworkManager singleton
        {
            get; private set;
        }

        #region Properties
        public int Id => NetworkClient.connection.connectionId;
        #endregion
        ...
        /// </summary>
        public event Action<NetworkConnectionToClient> OnClientReady;
        /// <summary>
        ...
        /// Called on clients when disconnected from a server.
        /// </summary>
        public event Action OnServerNotReady;
        /// <summary>
