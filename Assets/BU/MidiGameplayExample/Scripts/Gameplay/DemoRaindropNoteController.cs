...
{
    public class DemoRaindropNoteController : MonoBehaviour, IMusicNotationControllable
    {
        [SerializeField]
        ...
        protected Dictionary<int, RaindropNote> m_RaindropNoteStorage;
        ...
        public virtual void Init(float spawnPointPosY)
        {
            ...
            m_RaindropNoteStorage = new Dictionary<int, RaindropNote>();
        ...
        private void OnShowNoteNameSet(bool isActive)
        {
